...
```typescript
constructor(value: string | Buffer | String, size?: number)
```

**Parameters:**

- `value`: Initial value (string, buffer, or another String)
...
const str2 = new String(str1.data());
...
Inherits all methods from `String`, plus:
